...
# Uses beta student-T (bT) priors instead of beta gamma and trunc-norm trunc-T (nT).
# Same results as beta gamma, nT and Stan. Still slow though
...
inits <- function (){
  list(phi=10*runif(1), ppi=runif(1))
}
...
fit <- jags(data=dat,
            ...
            n.chains=4,
            model.file = system.file("jags/negbin-beta_trunc-T.bug.R", package = "bayesutils"))
fit
